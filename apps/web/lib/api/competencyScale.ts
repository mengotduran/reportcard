 ...
 *
 * Never rejects. Every caller is a rendering path — a marks picker, a report card, a print
 * page — and a card must still draw if this request fails, using the same built-ins the
 * server would have sent for an uncustomised school.
 */
