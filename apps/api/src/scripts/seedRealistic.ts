/**
 * Seeds a realistic multi-year secondary school into the current school
 * (Greenfield Academy): Form 1 → Upper Sixth, two academic years (2024/2025 and
 * 2025/2026), 3 terms each, hundreds of randomly-named students with gender,
 * random marks (/20) with computed averages + class positions.
 *
 * Model per the product decisions:
 *  - A student belongs to ONE class; promotion = a NEW student record next year
 *    (last year's students are kept INACTIVE so the roster shows the current year;
 *    their report cards persist and drive the 2024/2025 academic-year view).
 *  - Optional ("not compulsory") subjects: Subject.compulsory=false; a student may
 *    not take one (then there's simply no entry — excluded from the average).
 *  - 2024/2025: fully filled + PUBLISHED. 2025/2026: First+Second full+PUBLISHED,
...
const CLASSES: ClassDef[] = [
  { name: 'Form 1', fee: 75000, girls: 30, boys: 20, subjects: [
  ...
  { name: 'Form 2', fee: 75000, girls: 25, boys: 20, subjects: [
    c('Chemistry',3),c('Biology',3),c('Physics',3),c('English',5),c('French',5),c('Mathematics',5),c('Citizenship',3),c('History',3),c('Geography',3),c('Religious Studies',2),c('Sports',1),c('Literature',3),c('Computer Science',3) ] },
  { name: 'Form 3', fee: 75000, girls: 20, boys: 20, subjects: [
  ...
  { name: 'Form 4 Science', fee: 85000, girls: 20, boys: 20, subjects: [
  ...
  { name: 'Form 4 Arts', fee: 85000, girls: 30, boys: 25, subjects: [
  ...
  { name: 'Form 5 Science', fee: 85000, girls: 20, boys: 20, subjects: [
  ...
  { name: 'Form 5 Arts', fee: 85000, girls: 20, boys: 20, subjects: [
  ...
  { name: 'Lower Sixth Science S1', fee: 100000, girls: 20, boys: 10, subjects: [
    c('Chemistry',5),c('Biology',5),c('Physics',5),c('Mathematics',5),c('Sports',1),o('Further Mathematics',5) ] },
  { name: 'Lower Sixth Science S2', fee: 100000, girls: 20, boys: 10, subjects: [
    c('Chemistry',5),c('Biology',5),c('Physics',5),c('Mathematics',5),c('Sports',1),o('Computer Science',5) ] },
  { name: 'Lower Sixth Science S3', fee: 100000, girls: 9, boys: 6, subjects: [
    c('Chemistry',5),c('Biology',5),c('Geology',5),c('Sports',1) ] },
  { name: 'Lower Sixth Arts A1', fee: 100000, girls: 10, boys: 11, subjects: [
    c('History',5),c('French',5),c('Literature',5),c('Sports',1) ] },
  { name: 'Lower Sixth Arts A2', fee: 100000, girls: 20, boys: 10, subjects: [
    c('History',5),c('Geography',5),c('Economics',5),c('Sports',1),o('Mathematics',5) ] },
  { name: 'Lower Sixth Arts A3', fee: 100000, girls: 9, boys: 6, subjects: [
    c('History',5),c('Literature',5),c('Economics',5),c('Sports',1),o('Mathematics',5) ] },
  { name: 'Upper Sixth Science S1', fee: 100000, girls: 20, boys: 10, subjects: [
    c('Chemistry',5),c('Biology',5),c('Physics',5),c('Mathematics',5),o('Further Mathematics',5) ] },
  { name: 'Upper Sixth Science S2', fee: 100000, girls: 20, boys: 10, subjects: [
    c('Chemistry',5),c('Biology',5),c('Physics',5),c('Mathematics',5),o('Computer Science',5) ] },
  { name: 'Upper Sixth Science S3', fee: 100000, girls: 9, boys: 6, subjects: [
    c('Chemistry',5),c('Biology',5),c('Geology',5) ] },
  { name: 'Upper Sixth Arts A1', fee: 100000, girls: 10, boys: 11, subjects: [
    c('History',5),c('French',5),c('Literature',5) ] },
  { name: 'Upper Sixth Arts A2', fee: 100000, girls: 20, boys: 10, subjects: [
...
async function main() {
  ...
  if (!school) throw new Error('Target school (Greenfield Academy) not found')
    ...
    for (const cl of CLASSES) {
      ...
      for (const gender of genders) {
        ...
        studentRows.push({
          ...
          gender, studentId: `${sess.session.slice(2, 4)}-${String(counter).padStart(4, '0')}`,
          classLevel: cl.name, isActive: sess.current,
        })
        const ability = 5 + Math.random() * 10 // 5..15 baseline keeps a student's marks correlated
        const studentSubjects = [...compulsory, ...optional.filter(() => Math.random() < 0.65)]

        for (const term of terms) {
          const currentTerm = sess.current && term.index === 2
          if (currentTerm && Math.random() < 0.25) continue // some students have no card yet in the live term
      ...
      // positions per term (dense rank by average desc; unfilled cards get no position)
  ...
  console.log(`Inserting ${studentRows.length} students, ${cardRows.length} report cards, ${entryRows.length} entries…`)
