...
//
// Mirrored in apps/web/lib/phoneValidation.ts and apps/mobile/lib/phone.ts for live
// client-side feedback — keep the three in sync by hand; there's no shared package between
// the apps to import from (same arrangement as utils/passwordValidation.ts).
//
