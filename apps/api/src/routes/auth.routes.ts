...
import { registerSchool, login, getMe, updatePreferredLanguage, updateMyEmail, createSuperAdmin, resetSuperAdminPassword, resetUserPassword } from '../controllers/auth.controller'
