...
// apps/web/lib/phoneValidation.ts. Keep the three in sync by hand; there is no shared
// package between the apps to import from (same arrangement as passwordValidation).
//
