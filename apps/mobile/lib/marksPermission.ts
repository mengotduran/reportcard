 ...
 * administration.
 *
 * Mirrors the web helper of the same name and, behind both, saveEntries — which is what
 * actually decides. The same rule drifted across three call sites once before.
 */
