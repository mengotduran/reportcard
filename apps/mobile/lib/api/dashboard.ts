...
// Same `session` as getDashboardStats — the trend under a figure has to be a history OF
// that figure, so both follow the academic-year selector together.
export const getWeeklyStats = async (session?: string): Promise<WeeklyStats> => {
